...
public class Switch extends GameObject implements Interactive {
	...
	public Switch(int tileX, int tileY, int w, int h, String name, TiledMap map, Properties args) throws SlickException {		
	...
	public void interact(int interactionType){
		...
		if (interactionType == Interactive.INTERACTION_TOGGLE){
			state = !state;		
			((Interactive) target).interact(interactionType);
		}
	}
